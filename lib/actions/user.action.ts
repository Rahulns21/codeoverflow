...
import { GetUserAnswersParams, GetUserParams, GetUserQuestionsParams } from "@/app/types/action";
...
export async function getUsersQuestions(params: GetUserQuestionsParams): Promise<
  ActionResponse<{
